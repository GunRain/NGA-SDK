# [Re:Next - Flutter](https://app.niggergo.work/ren/flutter)
...
<Callout type="idea" title="Flutter 与 CMP">
  ...
  虽然 Flutter 也会有 **Canvaskit** 的依赖，但是 Flutter 默认会走**谷歌 CDN**，并不需要过多操心，谷歌 CDN 无论是在中国大陆还是其他地方，速度都是相当可观的（*IP 太脏当我没说*）
  ...
  随地设变量虽然很多时候确实比较有需求，但是这样就不太约束人了（*代码质量*`--`），并且这也导致了 Compose 有了一种另样的界面架构：弹窗
...
<Callout>
  ...
  尤其是在写跨平台软件或包时，更应当使用（*虽然不知道写包在什么情况下能用*）
</Callout>
