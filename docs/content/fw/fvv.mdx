...
<include lang='plaintext'>eg.fvv</include>
...
<Callout type='idea'>FVV `2` 在 FVV `1` 的基础上有了大幅度改进，详见[此处](./fvv-1-to-2.mdx)</Callout>
...
<Tab>
<Callout type='warn'>远程依赖仅可在 Go `1.25`+ 可用！</Callout>
